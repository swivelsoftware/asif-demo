...
var props = {
  ...
  colours: {
    // Cache the colours
    globeDots: 'blue', // No need to use the Three constructor as this value is used for the HTML canvas drawing 'fillStyle' property
    lines: new THREE.Color('blue'),
    lineDots: new THREE.Color('blue')
  },
  alphas: {
